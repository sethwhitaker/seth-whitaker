...
get_header(); ?>
		...
		<div id="content">
			<div id="image-rotator">
				<span id="back" class="arrow back"><a href="#">«</a></span>
				...
				<div id="proj-info">
					<div id="fade">
						...
						<div id="proj-tags">
							...
							<span>Away3D</span>
							<span>Wordpress</span>												</div>
					</div>					</div>				<span id="next" class="arrow forward"><a href="#">»</a></span>
			</div>
			<div id="personal-info">
				<div class="home-col floatLeft">
					<h2>WHO I AM</h2>
					<p>My name's Seth and I'm a 22 year old guy from New York City.	I love all things sports related and anything to do with the Web. </p>				</div>
				<div class="home-col floatLeft">
					<h2>WHAT I DO</h2>
					<p>Im a creative web developer who loves using HTML, CSS, Javascript and PHP to come up with new and exciting sites for the web. I currently work as an Associate Web Developer	at Magnani Caruso Dutton in New York City.</p>				</div>
				<div class="home-col floatLeft">
					<h2>WHY I DO IT</h2>
